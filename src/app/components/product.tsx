    ...
    return ( 
        <section>
            <div className="w[1920] h[full]">
                    ...
                    <h2 className="text-xl font-semibold pl-10 text-center pb-10">Our Products</h2>
                    </div>
                
            <div className="hidden md:block">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mx-28 lg:mx-48">
          {products.map((product) => (
           ...
           <div className="block md:hidden px-20">
            <Carousel
          opts={{
            align: "start",
          }}
